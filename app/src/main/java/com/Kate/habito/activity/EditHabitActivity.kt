package com.Kate.habito.activity
...
import com.Kate.habito.analytics.HabitoAnalytics
import com.Kate.habito.model.Habit
import com.Kate.habito.model.HabitRecord
import com.Kate.habito.model.ReminderTime
import com.Kate.habito.model.ResetFrequency
import com.Kate.habito.picker.TimePickerFragment
import com.Kate.habito.sync.FirebaseSyncUtils
import com.Kate.habito.util.HabitoScoreUtils
...
class EditHabitActivity : AppCompatActivity(), TimePickerFragment.OnTimeSetListener {
    ...
    companion object {
        val EDIT_HABIT_RESULT = "com.Kate.habito.activities.edit_result"
        val EDIT_HABIT_EXTRA_KEY = "com.Kate.habito.activities.edit"
    }
}
